...
const PlaylistItem: React.FC = () => {
  const { songsArtist, fetchArtistSongsPending } = useAppSelector(({ artists }) => {
    return {
      songsArtist: artists.songsArtist.tracks,
      fetchArtistSongsPending: artists.fetchArtistSongsPending,
    };
  });
  return (
